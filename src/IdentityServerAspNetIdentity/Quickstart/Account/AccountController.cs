...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            //returnUrl = string.Concat(returnUrl, "&acr_values=idp:Google");
            ...
            if (vm.IsExternalLoginOnly)
            {
                ...
                return RedirectToAction("Challenge", "External", new { provider = vm.ExternalLoginScheme, returnUrl, loginHint = vm.Username });
            }
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var rrr = await _signInManager.GetTwoFactorAuthenticationUserAsync();
        ...
        private async Task<LoginViewModel> BuildLoginViewModelAsync(string returnUrl)
        {
            ...
            if (providers.Count == 1)
            {
                ...
                vm.ExternalProviders = new[] { new ExternalProvider { AuthenticationScheme = providers[0].AuthenticationScheme } };
                return vm;
            }
